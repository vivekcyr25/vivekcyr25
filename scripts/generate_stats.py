...
def generate_streak_svg(stats: dict) -> str:
    ...
    parts.append(f'  <text x="82.5" y="80" font-family="Segoe UI,Arial,sans-serif" font-size="28" font-weight="700" fill="#F8FAFC" text-anchor="middle" filter="url(#softGlow)" font-variant-numeric="tabular-nums">{total_contribs:,}</text>')
    parts.append('  <text x="82.5" y="118" font-family="Segoe UI,Arial,sans-serif" font-size="13.5" font-weight="600" fill="#00F5D4" text-anchor="middle" letter-spacing="0.3">Total Contributions</text>')
    parts.append('  <text x="82.5" y="145" font-family="Segoe UI,Arial,sans-serif" font-size="11.5" fill="#94A3B8" text-anchor="middle">Aug 20, 2025 – Present</text>')
    parts.append('')
    parts.append('  <!-- ════ CENTER: Current Streak ════ -->')
    parts.append('  <!-- Calming Breathing Flame (Positioned cleanly above the ring) -->')
    parts.append('  <g transform="translate(247.5, 12)">')
    parts.append('    <g transform="scale(0.85) translate(0, 0)">')
    ...
    parts.append('  <circle cx="247.5" cy="74" r="34" fill="none" stroke="url(#tealRing)" stroke-width="3.5" filter="url(#softGlow)">')
    ...
    parts.append('  <circle cx="247.5" cy="74" r="39" fill="none" stroke="url(#orbitRing)" stroke-width="1.6" stroke-dasharray="12 9" stroke-linecap="round" opacity="0.75">')
    parts.append('    <animateTransform attributeName="transform" type="rotate" from="0 247.5 74" to="360 247.5 74" dur="24s" repeatCount="indefinite"/>')
    parts.append('  </circle>')
    parts.append(f'  <text x="247.5" y="82" font-family="Segoe UI,Arial,sans-serif" font-size="26" font-weight="700" fill="#FFFFFF" text-anchor="middle" filter="url(#softGlow)">{curr_streak}</text>')
    ...
    parts.append(f'  <text x="412.5" y="80" font-family="Segoe UI,Arial,sans-serif" font-size="28" font-weight="700" fill="#FFFBEB" text-anchor="middle" filter="url(#softGlow)" font-variant-numeric="tabular-nums">{long_streak}</text>')
    parts.append('  <text x="412.5" y="118" font-family="Segoe UI,Arial,sans-serif" font-size="13.5" font-weight="600" fill="#FBBF24" text-anchor="middle" letter-spacing="0.3">Longest Streak</text>')
    parts.append(f'  <text x="412.5" y="145" font-family="Segoe UI,Arial,sans-serif" font-size="11.5" fill="#94A3B8" text-anchor="middle">{l_start} – {l_end}</text>')
    parts.append('  <!-- ── Footer Micro Readout ── -->')
    parts.append('  <g transform="translate(136, 180)">')
    parts.append('    <circle cx="0" cy="0" r="2.5" fill="#00F5D4" opacity="0.9">')
